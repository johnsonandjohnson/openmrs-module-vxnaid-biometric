...
OpenMRS Biometric Module
==========================

## Description
A Biometric module provides REST APIs to retrieve configurations, register and match participants using bio-graphich
and biometric information  and, match a participant, create/update visit and creating encounters.
...
## Installation
This module requires neurotechnology SDKs to register and match participant's biometrics. The lib folder includes
neurotechnology SDKS which will be installed as part of the maven build
