...
package org.openmrs.module.biometric.extension.html;
...
public class AdminList extends AdministrationSectionExt {
  ...
  public Map<String, String> getLinks() {
    ...
    map.put("/ms/uiframework/resource/vxnaidbiometric/swagger/index.html", "biometric.refapp.title");
    return map;
  }
