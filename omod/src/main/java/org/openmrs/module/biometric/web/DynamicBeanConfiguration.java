...
package org.openmrs.module.biometric.web;
...
@Configuration("biometric.dynamicBeanConfiguration")
...
public class DynamicBeanConfiguration {
  ...
  public AbstractHandlerExceptionResolver getHandlerExceptionResolver() throws Exception {
    ...
    AbstractHandlerExceptionResolver bean;
